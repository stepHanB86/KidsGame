...
This project is a simple game for children developed with Pygame. It was created as part of my retraining, with my focus on applying what I have learned in practice.
...
There are some bugs that still need to be fixed.

The functions for spawning objects and other mechanics should be converted into classes to make the code more maintainable and readable.
